...
- Headless Command Code does not currently expose interactive per-tool approvals to this webview. Agent mode therefore uses explicit `auto-accept` consent and stays active until you switch back to Analyze.
